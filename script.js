...
const checkForWinner = () => {
    ...
    if (
     ...
     {
        declare.innerText = `Winner is ${player1.name}`;
    ...
    {
        declare.innerText = `Winner is ${player2.name}`;
        winner += 1; 
    }
    else if(
    typeof board[0] == "string" && typeof board[1] == "string" &&
    typeof board[2] == "string" && typeof board[3] == "string" &&
    typeof board[4] == "string" && typeof board[5] == "string" &&
    typeof board[6] == "string" && typeof board[7] == "string" &&
